...
###############################################################################################
# Rocha
#CHARCOS_ROCHA <- read_table2("~/Dropbox/H2020/RETROMED/CHARCOS_ROCHA.txt")
...
a.Rocha<- out.d50.obs.landscape.Rocha
...
S.o.Rocha<-ggplot(data.frame(a))+aes(d,S, col=Gr)+geom_point()+
  labs(title="Rocha (61 ponds)", y="Local Richness", x="Disperal ability")+
...
S.o.Rocha<-S.o.Rocha+annotation_custom(ggplotGrob(S.ratio), xmin = log10(300), xmax = log10(2000),  ymin = 2, ymax = 19)
...
B.o.Rocha<-ggplot(data.frame(a))+aes(d,Be.all, col=Gr)+geom_point()+
  labs( y="Beta", x="Disperal ability", title =" ")+
  scale_x_log10()+theme_bw()+
...
B.o.Rocha<-B.o.Rocha + annotation_custom(ggplotGrob(B.ratio), xmin = log10(500), xmax = log10(2500),  ymin = .5, ymax = .95)


grid.arrange(S.o.Rocha, B.o.Rocha, ncol=2)# FIGURE 1

#################################################################################################################
# Rocha NULL MODEL
# sequence of D50
random_vs_real_D50.Rocha<-H2020_Random_Landscape_local_ponds.D50(n.random = 140,Meta.pool=Meta.comm.Rocha, m.pool=0.01,  Js=Rocha[,8],
                                                                  id.module=Rocha[,7],
...
Rocha.Random<-landscape<-plotea.null.landscape.D50(random_vs_real_D50.Rocha)
random_vs_real_D50.Rocha_febrero2023<-random_vs_real_D50.Rocha
#################################################################################################################
...
############################################################
ppp.random_d50.500.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
                                             M.xy.J=Rocha, free.cores=2, JJ_in=8,
...
ppp.R.Gr.d50.500.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
                                           M.xy.J=Rocha, free.cores=2, JJ_in=8,
...
#ppp.R.Bt.d50.500.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
#                                    M.xy.J=Rocha, free.cores=2, JJ_in=8,
#                                    D50=500, m.max=1, loss.by="by.column",by_column_n=6,
#                                    id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
#                                    Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Cc.d50.500.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
                                           M.xy.J=Rocha, free.cores=2, JJ_in=8,
                                           D50=500, m.max=1, loss.by="by.column",by_column_n=5,
                                           id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                           Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

#ppp.R.Module.d50.500.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
#                                        M.xy.J=Rocha, free.cores=2, JJ_in=8,
...
ppp.R.500.Rocha<-list("random" = ppp.random_d50.500.Rocha, "Degree"=ppp.R.Gr.d50.500.Rocha, "Closennes" = ppp.R.Cc.d50.500.Rocha)

#par(mfcol=c(2,4))
#plotea(a = ppp.R.500.Rocha[[1]], b = ppp.R.500.Rocha)
#ppp->ppp.random_d50.500
###################################################################################3



ppp.random_d50.1000.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
                                              M.xy.J=Rocha, free.cores=2, JJ_in=8,
                                              D50=1000, m.max=1, loss.by="random",by_column_n=8,
                                              id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                              Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Gr.d50.1000.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
                                            M.xy.J=Rocha, free.cores=2, JJ_in=8,
...
#ppp.R.Bt.d50.1000<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
#                                     M.xy.J=Rocha, free.cores=2, JJ_in=8,
#                                     D50=1000, m.max=1, loss.by="by.column",by_column_n=6,
#                                     id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
#                                     Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Cc.d50.1000.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
                                            M.xy.J=Rocha, free.cores=2, JJ_in=8,
                                            D50=1000, m.max=1, loss.by="by.column",by_column_n=5,
                                            id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                            Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

#ppp.R.Module.d50.1000<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
#                                         M.xy.J=Rocha, free.cores=2, JJ_in=8,
...
ppp.R.1000.Rocha<-list("random" = ppp.random_d50.1000.Rocha, "Degree"=ppp.R.Gr.d50.1000.Rocha, "Closennes" = ppp.R.Cc.d50.1000.Rocha)
#plotea(a = ppp.R.1000.Rocha[[1]], b = ppp.R.1000)
#ppp->ppp.random_d50.500
...
ppp.random_d50.100.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
                                             M.xy.J=Rocha, free.cores=2, JJ_in=8,
                                             D50=100, m.max=1, loss.by="random",by_column_n=8,
                                             id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                             Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Gr.d50.100.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
                                           M.xy.J=Rocha, free.cores=2, JJ_in=8,
...
#ppp.R.Bt.d50.100.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
#                                    M.xy.J=Rocha, free.cores=2, JJ_in=8,
#                                    D50=100, m.max=1, loss.by="by.column",by_column_n=6,
#                                    id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
#                                    Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Cc.d50.100.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
                                           M.xy.J=Rocha, free.cores=2, JJ_in=8,
                                           D50=100, m.max=1, loss.by="by.column",by_column_n=5,
                                           id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                           Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

#ppp.R.Module.d50.100<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Rocha, m.pool=0.01,
#                                        M.xy.J=Rocha, free.cores=2, JJ_in=8,
...
ppp.R.100.Rocha<-list("random" = ppp.random_d50.100.Rocha, "Degree"=ppp.R.Gr.d50.100.Rocha, "Closennes" = ppp.R.Cc.d50.100.Rocha)
...
ppp.random_d50.2000.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,   # Random loss as refference
                                              M.xy.J=Rocha, free.cores=2, JJ_in=8,
                                              D50=2000, m.max=1, loss.by="random",by_column_n=8,
                                              id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                              Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Gr.d50.2000.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,      # Degree
                                            M.xy.J=Rocha, free.cores=2, JJ_in=8,
...
#ppp.R.Bt.d50.2000<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Rocha, m.pool=0.01,      # Betweenness
#                                     M.xy.J=Rocha, free.cores=2, JJ_in=8,
#                                     D50=2000, m.max=1, loss.by="by.column",by_column_n=6,
#                                     id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
#                                     Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Cc.d50.2000.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,      # Closeness
                                            M.xy.J=Rocha, free.cores=2, JJ_in=8,
                                            D50=2000, m.max=1, loss.by="by.column",by_column_n=5,
                                            id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                            Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

#ppp.R.Module.d50.2000<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Rocha, m.pool=0.01,   # Modules
#                                         M.xy.J=Rocha, free.cores=2, JJ_in=8,
...
ppp.R.2000.Rocha<-list("random" = ppp.random_d50.2000.Rocha, "Degree"=ppp.R.Gr.d50.2000.Rocha, "Closennes" = ppp.R.Cc.d50.2000.Rocha)


############################################################################################################
# D50 with the maximum effect on biodiversity
###################################################################################3
ii.max.diff<-which(f.hill.delta.Rocha(seq(1,3000,,10000))==max(f.hill.delta.Rocha(seq(1,3000,,10000))))
d50.max.S.ratio<-seq(1,3000,,10000)[ii.max.diff]
ii.max.diff.b<-which(f.hill.deltab.Rocha(seq(1,3000,,10000))==min(f.hill.deltab.Rocha(seq(1,3000,,10000))))
d50.max.B.ratio<-seq(1,3000,,10000)[ii.max.diff.b]

d50.max.diver<-(d50.max.S.ratio+d50.max.B.ratio)/2


ppp.random_d50.d50.max.diver.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,   # Random loss as refference
                                                         M.xy.J=Rocha, free.cores=2, JJ_in=8,
                                                         D50=d50.max.diver, m.max=1, loss.by="random",by_column_n=8,
                                                         id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                                         Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Gr.d50.d50.max.diver.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,      # Degree
                                                       M.xy.J=Rocha, free.cores=2, JJ_in=8,
                                                       D50=d50.max.diver, m.max=1, loss.by="by.column",by_column_n=4,
                                                       id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                                       Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Cc.d50.d50.max.diver.Rocha<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Rocha, m.pool=0.01,      # Closeness
                                                       M.xy.J=Rocha, free.cores=2, JJ_in=8,
...
ppp.R.d50.max.diver.Rocha<-list("random" = ppp.random_d50.d50.max.diver.Rocha, "Degree"=ppp.R.Gr.d50.d50.max.diver.Rocha, "Closennes" = ppp.R.Cc.d50.d50.max.diver.Rocha)

###########################################################################################################3
#### Figure 3 plot previous results
par(mfcol=c(2,5), lwd=1.3, cex=0.7, mar=c(2.5,2.5,.5,.5))
plotea(a = ppp.R.d50.max.diver.Rocha[[1]], b = ppp.R.d50.max.diver.Rocha)
plotea(a = ppp.R.100.Rocha[[1]], b = ppp.R.100.Rocha)
plotea(a = ppp.R.500.Rocha[[1]], b = ppp.R.500.Rocha)
plotea(a = ppp.R.1000.Rocha[[1]], b = ppp.R.1000.Rocha)
plotea(a = ppp.R.2000.Rocha[[1]], b = ppp.R.2000.Rocha)

land.lost<-plotea.gg(a = ppp.R.d50.max.diver.Rocha[[1]], b = ppp.R.d50.max.diver.Rocha, titulo = "Rocha")

grid.arrange(S.o.Rocha, B.o.Rocha, Roch.Random[[1]], Roch.Random[[2]], land.lost[[1]],land.lost[[2]],ncol=6, widths=c(1.5,1.5,.6,.6, .6,.6))
######################################################################################################
