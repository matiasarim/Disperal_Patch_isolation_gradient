...
a.Giara<- out.d50.obs.landscape.Giara
...
S.o.Giara<-ggplot(data.frame(a))+aes(d,S, col=Gr)+geom_point()+
  labs(title="Giara (160 ponds)", y="Local Richness", x=NULL)+
...
S.o.Giara<-S.o.Giara+annotation_custom(ggplotGrob(S.ratio), xmin = log10(900), xmax = log10(3200),  ymin = 0, ymax = 22)
...
M.hill.2b<-nls(B2~S0+(Smax-S0)*(d2^q)/(d50^q+d2^q), start = list(S0=10, Smax=1, q=-3, d50=50)   )
summary(M.hill.2b)
...
B.o.Giara<-ggplot(data.frame(a))+aes(d,Be.all, col=Gr)+geom_point()+
...
B.o.Giara<-B.o.Giara + annotation_custom(ggplotGrob(B.ratio), xmin = log10(40), xmax = log10(250),  ymin = .42, ymax = .74)


grid.arrange(S.o.Giara, B.o.Giara, ncol=2)# FIGURE 1
...
Giara.random<-plotea.null.landscape.D50(random_vs_real_D50.Giara_febrero_2023)
#################################################################################################################
...
############################################################
ppp.random_d50.500.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,
                                           M.xy.J=Giara, free.cores=2, JJ_in=8,
...
ppp.R.Gr.d50.500.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,
                                         M.xy.J=Giara, free.cores=2, JJ_in=8,
...
#ppp.R.Bt.d50.500.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Giara, m.pool=0.01,
#                                    M.xy.J=Giara, free.cores=2, JJ_in=8,
#                                    D50=500, m.max=1, loss.by="by.column",by_column_n=6,
#                                    id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
#                                    Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Cc.d50.500.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,
                                         M.xy.J=Giara, free.cores=2, JJ_in=8,
                                         D50=500, m.max=1, loss.by="by.column",by_column_n=5,
                                         id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                         Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

#ppp.R.Module.d50.500.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Giara, m.pool=0.01,
#                                        M.xy.J=Giara, free.cores=2, JJ_in=8,
...
ppp.R.500.Giara<-list("random" = ppp.random_d50.500.Giara, "Degree"=ppp.R.Gr.d50.500.Giara, "Closennes" = ppp.R.Cc.d50.500.Giara)

#par(mfcol=c(2,4))
#plotea(a = ppp.R.500.Giara[[1]], b = ppp.R.500.Giara)
#ppp->ppp.random_d50.500
###################################################################################3



ppp.random_d50.1000.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,
                                            M.xy.J=Giara, free.cores=2, JJ_in=8,
                                            D50=1000, m.max=1, loss.by="random",by_column_n=8,
                                            id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                            Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Gr.d50.1000.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,
                                          M.xy.J=Giara, free.cores=2, JJ_in=8,
...
#ppp.R.Bt.d50.1000<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Giara, m.pool=0.01,
#                                     M.xy.J=Giara, free.cores=2, JJ_in=8,
#                                     D50=1000, m.max=1, loss.by="by.column",by_column_n=6,
#                                     id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
#                                     Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Cc.d50.1000.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,
                                          M.xy.J=Giara, free.cores=2, JJ_in=8,
                                          D50=1000, m.max=1, loss.by="by.column",by_column_n=5,
                                          id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                          Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

#ppp.R.Module.d50.1000<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Giara, m.pool=0.01,
#                                         M.xy.J=Giara, free.cores=2, JJ_in=8,
...
ppp.R.1000.Giara<-list("random" = ppp.random_d50.1000.Giara, "Degree"=ppp.R.Gr.d50.1000.Giara, "Closennes" = ppp.R.Cc.d50.1000.Giara)
#plotea(a = ppp.R.1000.Giara[[1]], b = ppp.R.1000)
#ppp->ppp.random_d50.500
...
ppp.random_d50.100.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,
                                           M.xy.J=Giara, free.cores=2, JJ_in=8,
                                           D50=100, m.max=1, loss.by="random",by_column_n=8,
                                           id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                           Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Gr.d50.100.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,
                                         M.xy.J=Giara, free.cores=2, JJ_in=8,
...
#ppp.R.Bt.d50.100.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Giara, m.pool=0.01,
#                                    M.xy.J=Giara, free.cores=2, JJ_in=8,
#                                    D50=100, m.max=1, loss.by="by.column",by_column_n=6,
#                                    id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
#                                    Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Cc.d50.100.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,
                                         M.xy.J=Giara, free.cores=2, JJ_in=8,
                                         D50=100, m.max=1, loss.by="by.column",by_column_n=5,
                                         id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                         Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

#ppp.R.Module.d50.100<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Giara, m.pool=0.01,
#                                        M.xy.J=Giara, free.cores=2, JJ_in=8,
...
ppp.R.100.Giara<-list("random" = ppp.random_d50.100.Giara, "Degree"=ppp.R.Gr.d50.100.Giara, "Closennes" = ppp.R.Cc.d50.100.Giara)
...
ppp.random_d50.2000.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,   # Random loss as refference
                                            M.xy.J=Giara, free.cores=2, JJ_in=8,
                                            D50=2000, m.max=1, loss.by="random",by_column_n=8,
                                            id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                            Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Gr.d50.2000.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,      # Degree
                                          M.xy.J=Giara, free.cores=2, JJ_in=8,
...
#ppp.R.Bt.d50.2000<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Giara, m.pool=0.01,      # Betweenness
#                                     M.xy.J=Giara, free.cores=2, JJ_in=8,
#                                     D50=2000, m.max=1, loss.by="by.column",by_column_n=6,
#                                     id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
#                                     Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Cc.d50.2000.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,      # Closeness
                                          M.xy.J=Giara, free.cores=2, JJ_in=8,
                                          D50=2000, m.max=1, loss.by="by.column",by_column_n=5,
                                          id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                          Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

#ppp.R.Module.d50.2000<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=28, Meta.pool=Meta.comm.Giara, m.pool=0.01,   # Modules
#                                         M.xy.J=Giara, free.cores=2, JJ_in=8,
...
ppp.R.2000.Giara<-list("random" = ppp.random_d50.2000.Giara, "Degree"=ppp.R.Gr.d50.2000.Giara, "Closennes" = ppp.R.Cc.d50.2000.Giara)

############################################################################################################
# D50 with the maximum effect on biodiversity
###################################################################################3
ii.max.diff<-which(f.hill.delta.Giara(seq(1,3000,,10000))==max(f.hill.delta.Giara(seq(1,3000,,10000))))
d50.max.S.ratio<-seq(1,3000,,10000)[ii.max.diff]
ii.max.diff.b<-which(f.hill.deltab.Giara(seq(1,3000,,10000))==min(f.hill.deltab.Giara(seq(1,3000,,10000))))
d50.max.B.ratio<-seq(1,3000,,10000)[ii.max.diff.b]

d50.max.diver<-(d50.max.S.ratio+d50.max.B.ratio)/2


ppp.random_d50.d50.max.diver.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,   # Random loss as refference
                                                       M.xy.J=Giara, free.cores=2, JJ_in=8,
                                                       D50=d50.max.diver, m.max=1, loss.by="random",by_column_n=8,
                                                       id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                                       Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Gr.d50.d50.max.diver.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,      # Degree
                                                     M.xy.J=Giara, free.cores=2, JJ_in=8,
                                                     D50=d50.max.diver, m.max=1, loss.by="by.column",by_column_n=4,
                                                     id.fixed=0, D50.fixed=NULL, m.max.fixed=NULL, comm.fixed=NULL,
                                                     Lottery=FALSE, it=NULL, prop.dead.by.it=NULL)

ppp.R.Cc.d50.d50.max.diver.Giara<-H2020_Random.loss(proportion.removed=proportion.removed,n.random=112, Meta.pool=Meta.comm.Giara, m.pool=0.01,      # Closeness
                                                     M.xy.J=Giara, free.cores=2, JJ_in=8,
...
ppp.R.d50.max.diver.Giara<-list("random" = ppp.random_d50.d50.max.diver.Giara, "Degree"=ppp.R.Gr.d50.d50.max.diver.Giara, "Closennes" = ppp.R.Cc.d50.d50.max.diver.Giara)

###########################################################################################################3
#### Figure 3 plot previous results
par(mfcol=c(2,5), lwd=1.3, cex=0.7, mar=c(2.5,2.5,.5,.5))
plotea(a = ppp.R.Cc.d50.d50.max.diver.Giara[[1]], b = ppp.R.Cc.d50.d50.max.diver.Giara)
plotea(a = ppp.R.100.Giara[[1]], b = ppp.R.100.Giara)
plotea(a = ppp.R.500.Giara[[1]], b = ppp.R.500.Giara)
plotea(a = ppp.R.1000.Giara[[1]], b = ppp.R.1000.Giara)
plotea(a = ppp.R.2000.Giara[[1]], b = ppp.R.2000.Giara)


land.lost<-plotea.gg(a = ppp.R.d50.max.diver.Giara[[1]], b = ppp.R.d50.max.diver.Giara)
grid.arrange(S.o.Giara, B.o.Giara, Giara.random[[1]], Giara.random[[2]], land.lost[[1]],land.lost[[2]],ncol=6, widths=c(1.5,1.5,.6,.6, .6,.6))
plotea.gg(a = ppp.R.Cc.d50.d50.max.diver.Giara[[1]], b = ppp.R.Cc.d50.d50.max.diver.Giara, titulo = "Guiara")
######################################################################################################
